...
from .raw_eeg_dataset import FileEegDataset
...
class EegPretrainingConfig(FairseqDataclass):
    ...
    inferred_w2v_config: Optional[InferredEegConfig] = field(
        default=None,
        metadata={
...
class EegPretrainingTask(FairseqTask):
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        self.datasets[split] = FileEegDataset(
