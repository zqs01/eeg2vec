...
@dataclass
class Eeg2vecConfig(FairseqDataclass):
    ...
    conv_feature_layers: str = field(
        default="[(512, 10, 5)] + [(512, 3, 2)] * 3 + [(512,2,2)] ",
        metadata={
...
@register_model("eeg2vec", dataclass=Eeg2vecConfig)
class Eeg2vecModel(BaseFairseqModel):
    def __init__(self, cfg: Eeg2vecConfig):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: Eeg2vecConfig, task=None):
...
class TransformerEncoder(nn.Module):
    def build_encoder_layer(self, args: Eeg2vecConfig):
    ...
    def __init__(self, args: Eeg2vecConfig):
        super().__init__()
